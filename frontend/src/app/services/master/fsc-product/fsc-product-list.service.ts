...
export class FscProductListService {
  ...
  private _search(): Observable<SearchResult> {
    ...
    */
    ...
    return this.http.post<SearchResult>(`${environment.apiUrl}/master/fsc-product/index`,{page,pageSize,searchTerm,sortColumn,sortDirection}).pipe(
        map(result => {
  ...
  addProduct(productData){
    ...
    //let productDatas = Object.assign({}, productData);
    return this.http.post<any>(`${environment.apiUrl}/master/fsc-product/create`, productData);
    //, JSON.stringify(data)
  }

  getProduct():Observable<any>{
    
    return this.http.get<any>(`${environment.apiUrl}/master/fsc-product/index`,this.httpOptions);
  ...
  commonActionData(data): Observable<any>{
    return this.http.post<any>(`${environment.apiUrl}/master/fsc-product/common-update`,data);
  }
}
