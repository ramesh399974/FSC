...
export class FscProducttypeL1ListService {
  ...
  get producttypes$() { return this._producttypes$.asObservable(); }
  ...
  private _search(): Observable<SearchResult> {
    ...
    */
    ...
    return this.http.post<SearchResult>(`${environment.apiUrl}/master/fsc-producttype-l1/index`,{page,pageSize,searchTerm,sortColumn,sortDirection}).pipe(
        map(result => {
  ...
  addProductType(producttypeData){
    ...
    return this.http.post<any>(`${environment.apiUrl}/master/fsc-producttype-l1/create`, producttypeData);
    //, JSON.stringify(data)
  }

  getProductType():Observable<any>{
    
    return this.http.get<any>(`${environment.apiUrl}/master/fsc-producttype-l1/index`,this.httpOptions);
  ...
  commonActionData(data): Observable<any>{
    return this.http.post<any>(`${environment.apiUrl}/master/fsc-producttype-l1/common-update`,data);
  }
}
