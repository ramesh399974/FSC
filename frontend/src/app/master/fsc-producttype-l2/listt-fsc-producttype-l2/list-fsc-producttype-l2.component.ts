...
import { FscProducttypeL2ListService } from '@app/services/master/fsc-producttype-l2/fsc-producttype-l2-list.service';
...
@Component({
  selector: 'app-list-fsc-producttype-l2',
  templateUrl: './list-fsc-producttype-l2.component.html',
  styleUrls: ['./list-fsc-producttype-l2.component.scss'],
  providers:[FscProducttypeL2ListService]
})
export class ListFscProducttypeL2Component  {
  ...
  constructor(public fscproducttype2service: FscProducttypeL2ListService,private modalService: NgbModal,private errorSummary: ErrorSummaryService, private authservice:AuthenticationService) {
    this.producttypes$ = fscproducttype2service.producttypesone$;
    this.total$ = fscproducttype2service.total$;
  ...
  onSort({column, direction}: SortEvent) {
    ...
    this.fscproducttype2service.sortColumn = column;
    this.fscproducttype2service.sortDirection = direction;
  }
  ...
  open(content,action,id) {
    ...
    this.fscproducttype2service.commonActionData({id:this.model.id,status:actionStatus}).pipe(first())
      .subscribe(res => {
      this.model.id = null;
      ...
      if(res.status){
        ...
        this.fscproducttype2service.searchTerm=this.fscproducttype2service.searchTerm;
