...
const masterRoutes: Routes = [
  ...
  { path: 'master/fsc-standard/add-fsc',  component: AddFscStandardComponent,canLoad: [AuthGuard],canActivate: [AuthGuard],data: { usertype:[1], rules:'add_standard', roles: [Role.Admin] } },
