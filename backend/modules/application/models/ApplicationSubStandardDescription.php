...
class ApplicationSubStandardDescription extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'tbl_application_sub_standard_description';
    }
    ...
    public function attributeLabels()
    {
        return [
            'id' => 'ID',
            'app_id' => 'App ID',
            'sub_standard_desc' => 'Sub Standard Description',
        ];
    }
